...
[pattern] feature-progress: Phases 1–5 (write) built, tested, and verified live. Phase 5 = composer (image paste + @mention autocomplete), reply, create-thread-on-paragraph, thread-status, edit/delete own comments. Next: Phase 6 = toolbar popup + options page (allowlist).
