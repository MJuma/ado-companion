...
[pattern] feature-progress: Phases 1–4 + 5a built, tested, and verified live. 5a (write) = CommentComposer (image paste/drop/picker → uploadAttachment), reply + status controls, click-paragraph-to-create-thread (buildLineThreadContext), rail refetch after mutate. Next: 5b edit/delete own, 5c @mentions, Phase 6 popup/options.
